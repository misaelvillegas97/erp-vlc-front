...
const {material3Palette} = require("./src/@fuse/styles/_theme-colors");
...
const themes = {
    default: {
        primary: material3Palette.primary,
        accent: material3Palette.neutral,
        warn: material3Palette.error,
        'on-warn': {
            500: '#ffffff'
        },
        neutral: material3Palette.neutral,
    }
};
