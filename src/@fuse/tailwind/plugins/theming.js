...
const {material3Palette} = require("../../styles/_theme-colors");
                  ...
                  customProps: {
                      background: {
                          light: {
                              'bg-app-bar': '#FFFFFF',
                              'bg-card': '#FFFFFF',
                              'bg-default': material3Palette.neutral[50],
                              'bg-secondary': material3Palette.secondary[50],
                              'bg-dialog': '#FFFFFF',
                              'bg-hover': chroma(material3Palette.neutral[400])
                                .alpha(0.12)
                                .css(),
                              'bg-status-bar': material3Palette.neutral[300],
                          },
                          dark: {
                              'bg-app-bar': material3Palette.neutral[900],
                              'bg-card': material3Palette.neutral[700],
                              'bg-default': material3Palette.neutral[800],
                              'bg-secondary': material3Palette.secondary[900],
                              'bg-dialog': material3Palette.neutral[700],
                              'bg-hover': 'rgba(255, 255, 255, 0.05)',
                              'bg-status-bar': material3Palette.neutral[800],
                          },
                      },
                      foreground: {
                          light: {
                              'text-default': material3Palette.neutral[800],
                              'text-secondary': material3Palette.neutral[500],
                              'text-hint': material3Palette.neutral[400],
                              'text-disabled': material3Palette.neutral[400],
                              border: colors.slate[200],
                              divider: colors.slate[200],
                              icon: material3Palette.neutral[500],
                              'mat-icon': material3Palette.neutral[500],
                          },
                          dark: {
                              'text-default': '#DDDDDD',
                              'text-secondary': material3Palette.neutral[400],
                              'text-hint': material3Palette.neutral[500],
                              'text-disabled': material3Palette.neutral[600],
                              ...
                              divider: chroma(colors.slate[100])
                                .alpha(0.12)
                                .css(),
                              icon: material3Palette.neutral[400],
                              'mat-icon': material3Palette.neutral[400],
                          },
                      },
                  },
              },
